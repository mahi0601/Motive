...
const TaskForm = ({ onSubmit, onClose, initialData = null }) => {
  ...
  const categories = ['Personal', 'Work', 'Health', 'Finance', 'Development'];
    ...
    >
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-medium text-light-text dark:text-dark-text mb-2 flex items-center gap-2">
                <FiFlag className="text-brand-500" /> Priority
              </label>
              <select
            ...
            <div>
              <label className="block text-sm font-medium text-light-text dark:text-dark-text mb-2 flex items-center gap-2">
                <FiCalendar className="text-brand-500" /> Due Date
              </label>
              <input
                type="date"
          ...
          <div>
            <label className="block text-sm font-medium text-light-text dark:text-dark-text mb-2 flex items-center gap-2">
              <FiTag className="text-brand-500" /> Tags
            </label>

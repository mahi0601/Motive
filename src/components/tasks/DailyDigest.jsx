    ...
    >
      ...
      {digest.focusTask && (
        <button
          ...
          className="w-full text-left flex items-center gap-3 p-3 rounded-lg border border-brand-200 dark:border-brand-700 bg-brand-50 dark:bg-brand-900/20 hover:bg-brand-100 dark:hover:bg-brand-900/30 transition-colors mb-3"
        >
          <Target className="w-4 h-4 text-brand-600 dark:text-brand-400 flex-shrink-0" />
          <div className="min-w-0">
            <p className="text-xs text-brand-700 dark:text-brand-400 font-medium">Tackle this first</p>

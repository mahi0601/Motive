...
import { Calendar, CheckCircle, Clock, Edit, Flag, Repeat, Tag, Trash2 } from 'lucide-react';
    ...
    >
      ...
      {(task.category || task.recurrence) && (
        <div className="mb-2 flex flex-wrap items-center gap-1.5">
          ...
          {task.recurrence && (
            <span
              className="inline-flex items-center gap-1 px-2 py-1 bg-light-border/40 dark:bg-dark-surface text-light-muted dark:text-dark-muted rounded-md text-xs font-medium"
